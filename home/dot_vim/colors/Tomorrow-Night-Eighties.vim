...
" background should not set to foreground
let s:background = ""
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" darker yellow on black background with underline
	call <SID>X("Search", "cda452", "302028", "underline")
	...
	call <SID>X("diffDelete", "222222", s:red, "")
